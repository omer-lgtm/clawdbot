...
const FIELD_LABELS: Record<string, string> = {
  ...
  "openSpark.enabled": "Enable Open Spark Workspace",
  "openSpark.security.requireConsent": "Require Operator Consent",
  "openSpark.security.consentMode": "Consent Mode",
  "openSpark.security.allowSecretsAfterConsent": "Allow Secrets After Consent",
  "openSpark.memory.operatorControls": "Operator Memory Controls",
  "openSpark.memory.maxEntries": "Open Spark Memory Max Entries",
  "openSpark.models.allowModelSelection": "Allow Model Selection",
  "openSpark.models.defaultModel": "Default Open Spark Model",
  "openSpark.integrations.n8nBaseUrl": "n8n Base URL",
  "openSpark.integrations.mcpServers": "MCP Servers",
  "openSpark.browserExtension.enabled": "Browser Extension Bridge",
  "openSpark.browserExtension.allowedOrigins": "Allowed Browser Origins",
